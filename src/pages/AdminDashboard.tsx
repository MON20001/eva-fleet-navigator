...
import { Users, Bus, Truck, AlertTriangle, BarChart3, Shield } from "lucide-react";
  ...
  <DashboardLayout>
    {(tab) => {
      ...
      if (tab === "users") return (
        <div className="glass-card p-5">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-display font-semibold">System Users</h3>
      ...
      if (tab === "analytics") return (
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <StatCard icon={BarChart3} label="On-Time Rate" value="92%" change="+3%" positive delay={0} />
            <StatCard icon={Bus} label="Avg Trip Duration" value="42 min" delay={0.1} />
            <StatCard icon={Users} label="Active Workers" value={85} change="+5" positive delay={0.2} />
          </div>
      ...
      if (tab === "reports") return (
        <div className="glass-card p-5">
          <h3 className="font-display font-semibold mb-4">System Reports</h3>
          <div className="space-y-3">
            {reports.map((r, i) => (
              <div key={i} className="flex items-center justify-between p-4 rounded-lg bg-secondary/50">
                <div className="flex items-center gap-3">
      ...
      return (
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard icon={Users} label="Total Workers" value={120} change="+8" positive delay={0} />
            <StatCard icon={Bus} label="Active Buses" value={15} delay={0.1} />
            <StatCard icon={Truck} label="Active Trucks" value={8} delay={0.2} />
            <StatCard icon={AlertTriangle} label="Open Reports" value={3} change="-2" positive delay={0.3} />
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-5">
                ...
                <div className="space-y-2">
                  {["Send Replacement Bus", "Broadcast Notification", "View All Reports"].map((a, i) => (
