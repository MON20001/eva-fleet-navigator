...
const roles: { role: UserRole; label: string; desc: string; icon: React.ElementType }[] = [
  ...
  { role: "admin", label: "Supervisor", desc: "Full system control & analytics", icon: Shield },
];
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 pt-12 lg:pt-24 pb-16 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-16">
          {features.map((f, i) => (
